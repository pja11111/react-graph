				...
				<ResponsiveContainer>
					<BarChart data={userActivityData}>
						...
						<Legend
							...
							iconType="square"
							payload={[
								{ value: "0-4", type: "square", color: "#6366F1" },
								{ value: "4-8", type: "square", color: "#8B5CF6" },
								{ value: "8-12", type: "square", color: "#EC4899" },
								{ value: "12-16", type: "square", color: "#10B981" },
								{ value: "16-20", type: "square", color: "#F59E0B" },
								{ value: "20-24", type: "square", color: "#3B82F6" },
							]}
						/>
						<Bar dataKey="0-4" stackId="a" fill="#6366F1" />
						<Bar dataKey="4-8" stackId="a" fill="#8B5CF6" />
